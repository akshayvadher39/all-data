...
int main() {
    ...
    if (choice == 1)
        account = new SavingsAccount("1001", "akshay vadher", 1000, 0.05);
    else if (choice == 2)
        account = new CheckingAccount("2001", "akshay vadher", 1000);
    else if (choice == 3)
        account = new FixedDeposit("3001", "akshay vadher", 5000, 0.08);
    else {
        cout << "Invalid choice!";
        return 0;
    }
